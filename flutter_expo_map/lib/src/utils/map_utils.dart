...
class MapUtil{
  ...
  final directions = APIDirections.GoogleMapsDirections(apiKey: 'AIzaSyCDmOVyxl5q0kgN1zZHMZHKHTsruzRN1bE');
  final geolocation = APIGeolocation.GoogleMapsGeolocation(apiKey: 'AIzaSyCDmOVyxl5q0kgN1zZHMZHKHTsruzRN1bE');
